...
\projectinfo{
  ...
  title.cs={Demonstrace - Kargerův algoritmus},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
  title.en={Demonstration - Karger's algorithm}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
  author={Kateřina Pilátová, Michal Tabášek},   %cele jmeno a prijmeni autora / full name and surname of the author
  author.name={},   %jmeno autora (pro citaci) / author name (for reference) 
  author.surname={},   %prijmeni autora (pro citaci) / author surname (for reference) 
  author.title.p=, %titul pred jmenem (nepovinne) / title before the name (optional)
  ...
  %Skolitel / supervisor
  supervisor=Jan , %cele jmeno a prijmeni skolitele / full name and surname of the supervisor
  supervisor.name={},   %jmeno skolitele (pro citaci) / supervisor name (for reference) 
  supervisor.surname={},   %prijmeni skolitele (pro citaci) / supervisor surname (for reference) 
...
\begin{document}
 ...
 %{\hypersetup{hidelinks}\tableofcontents}
  ...
  %\subfile{chapters/projekt-02-nekolik-}
  %\subfile{chapters/projekt-03-nikdy-to-nebude-dokonale} 
  %\subfile{chapters/projekt-04-typograficke-a-jazykove-zasady}
